            ...
            if (all != null)
            {
                ...
                for (int i = 2; i < rowCount; i++)
                {
                    ...
                    MouItem temp = new MouItem(
                        ...
                        pUDdiscountPerUnit: getValue(new string[] { "ppdiscountperunit" }, i, ref all, header) ?? "0",
                        ...
                        pUDdiscountPerPack: getValue(new string[] { "ppdiscountperpack" }, i, ref all, header) ?? "0",
